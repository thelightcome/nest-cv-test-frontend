...
import { Wrapper, Container, Title1, Sidebar, Profile, SidebarContent, SidebarBlock, ContactLink, Content, NameWrapper, PositionWrapper, AboutWrapper, ExperiencesWrapper, ExperienceWrapper } from '../styled/index.'
