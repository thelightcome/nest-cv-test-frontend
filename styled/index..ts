...
export {
  Wrapper, Container, Title1, ContactLink, Content, NameWrapper, PositionWrapper, AboutWrapper, ExperiencesWrapper, ExperienceWrapper, Sidebar, Profile, SidebarContent, SidebarBlock
}